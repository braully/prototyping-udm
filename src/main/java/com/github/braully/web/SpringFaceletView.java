...
/*
 * From: http://forum.spring.io/forum/spring-projects/web/18234-how-to-configure-spring-mvc-view-resolver-for-facelets  
 * From: https://github.com/acichon89/springmvcfacelets/blob/master/src/main/java/pl/cichon/andrzej/springmvcfacelets/common/mvc/FaceletView.java
 */
public class SpringFaceletView extends AbstractUrlBasedView {
    ...
    protected void renderMergedOutputModel(Map model, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        try {
            ...
            SpringFaceletView.notifyAfterListeners(PhaseId.RENDER_RESPONSE, facesLifecycle, facesContext);
        } catch (IOException e) {
